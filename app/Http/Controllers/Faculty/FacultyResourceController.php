...
class FacultyResourceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ])->whereHas('faculties', function($q) use($user){
        ...
        return view(config('app.f_slug').'.faculty_resources.index', compact('title', 'breadcrumb', 'batches', 'activeBatchesCount', 'completedBatchesCount', 'search', 'status', 'prevRecords'));
    }
