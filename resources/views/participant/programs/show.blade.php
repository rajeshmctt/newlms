        ...
        <div class="section3125">							
          <div class="row justify-content-center">						
            ...
            <div class="col-xl-8 col-lg-7 col-md-6">
              ...
              <ul class="_215b31">			
                @if(!$batch->batchUser)
                @if($batch->program->payment_mode == "offline")							
                <li><a data-toggle="modal" data-target="#enquiryModal"><button class="btn_adcart">Enquire Now</button></a></li>
                @elseif($batch->program->amount > 0)
                <li><a href="#"><button class="btn_buy"><i class="fa fa-rupee-sign"></i> {{ $batch->program->amount }}</button></a></li>
                <li><a href="#" data-toggle="modal" data-target="#optModal"><button class="btn_adcart">Enrol Now</button></a></li>
                @else
                <li><a href="#"><button class="btn_buy"><i class="fa fa-rupee-sign"></i> 0</button></a></li>
                <li><a href="#" disabled class="disabled"><button class="btn_adcart disabled" disabled>Enrol Now</button></a></li>
                @endif
                @endif
              </ul>
            </div>							
...
{{ Form::open(array('route' => [Config::get('app.p_slug').'.programs.batches.enquiry', [$batch->program->id, $batch->id]], 'method' => 'post')) }}

<div class="modal fade" id="enquiryModal" tabindex="-1" role="dialog" aria-labelledby="enquiryModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <h3 class="modal-title" id="enquiryModalLabel">{{ $batch->program->name }}</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <h3 class="mt-5 mb-5 text-center">Are you sure you want to Enquire about this Program?</h3>
      </div>
      <div class="modal-footer bg-secondary">
        <button type="button" class="btn_buy" data-dismiss="modal">No</button>
        <button type="submit" class="btn_adcart">Yes</button>
      </div>
    </div>
  </div>
</div>
