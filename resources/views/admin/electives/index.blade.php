          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <form action="{{ route(config('app.a_slug').'.electives.index')}}" method="get" style="display:inline;">
                ...
                <div class="card-tools">
                    <a href="{{ route(config('app.a_slug').'.electives.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add New</a>
                </div>
              </div>
              <!-- /.card-header -->
                    ...
                    <tr>
                      ...
                      <td>
                          {{ Form::open(array('route' => [config('app.a_slug').'.programs.destroy', $program->id], 'method' => 'delete')) }}
                            <a href="{{ route(config('app.a_slug').'.programs.edit', $program->id) }}" class="btn btn-sm"><i class="fas fa-edit"></i></a>
