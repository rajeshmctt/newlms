      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          ...
          <div class="card card-default">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{ route(config('app.a_slug').'.faculties.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-6">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        {{ Form::select('coach_type_ids[]', $coachTypes, old('coach_type_ids'), ['class' => 'form-control js-multiple-select', 'id' => 'coach_type_ids', 'multiple']) }}
