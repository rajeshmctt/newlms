      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-12">        
                <form action="{{ route(config('app.f_slug').'.mentor-coach-batches.index')}}" method="get" style="display:inline;">
                <ul class="more_options_tt mt-5">
                  <li class=""><a href="{{ route(config('app.f_slug').'.mentor-coach-batches.index')}}"><button type="button" class="more_items_14 {{ $status == 'active' ? 'active' : '' }}"><i class="fa fa-hourglass-half"></i> Active ({{ $activeBatchesCount }})</button></a></li>
                  <li class=""><a href="{{ route(config('app.f_slug').'.mentor-coach-batches.index', ['status' => 'completed'])}}"><button type="button" class="more_items_14 {{ $status == 'completed' ? 'active' : '' }}"><i class="fa fa-check-circle"></i> Completed ({{ $completedBatchesCount }})</button></a></li>
