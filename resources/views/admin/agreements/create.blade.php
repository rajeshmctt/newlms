      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          ...
          <div class="card card-default">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{ route(config('app.a_slug').'.agreements.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        <textarea name="content" class="form-control" id="tiny" placeholder="Content">{{ old('content') }}</textarea>
                        @error('content')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
