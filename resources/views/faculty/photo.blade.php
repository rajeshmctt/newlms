...
<div class="row">
  <div class="col-lg-12">
      ...
      {{ Form::open(array('route' => [Config::get('app.f_slug').'.account.update.photo'], 'method' => 'put', 'files' => true)) }}
        ...
        <div class="row">
          <div class="col-lg-8">
              <div class="mt-3 d-inline-block">						
                  ...
                  <img src="{{ asset('storage/faculties/'.$user->photo) }}" alt="">										
                  </div>									
              </div>
              ...
              <br>
              <div class="help-block" style="font-size:14px;">Kindly upload a high-resolution formal photo.</div>
