...
@if(Request::get('view') == 'list')
        ...
        <div class="fcrse_1 mb-3">
            ...
            <a href="{{ route(config('app.f_slug').'.programs.batches.show', [$upcomingProgramBatch->program->id, $upcomingProgramBatch->id]) }}"><button class="btn btn-info ml-3 rounded-pill"><i class="fa fa-eye"></i> View</button></a></div>
        </div>
        </div>
@else
...
.crse-cate{
  height: 100px;
        ...
        <div class="col-lg-3 col-md-3 mb-3">
            <div class="fcrse_1">
            <a href="{{ route(config('app.f_slug').'.programs.batches.show', [$upcomingProgramBatch->program->id, $upcomingProgramBatch->id]) }}" class="fcrse_img">
            ...
            <div class="fcrse_content">
                ...
                <a href="{{ route(config('app.f_slug').'.programs.batches.show', [$upcomingProgramBatch->program->id, $upcomingProgramBatch->id]) }}" class="crse14s"
                >{{ $upcomingProgramBatch->program->name }}
                </a>
                <a href="{{ route(config('app.f_slug').'.programs.batches.show', [$upcomingProgramBatch->program->id, $upcomingProgramBatch->id]) }}" class="crse-cate">
                ...
                <div class="prce142">
                    <a href="{{ route(config('app.f_slug').'.programs.batches.show', [$upcomingProgramBatch->program->id, $upcomingProgramBatch->id]) }}">
