              ...
              <form method="post" action="{{ route(config('app.a_slug').'.programs.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-3">
                      <div class="form-group">
                        ...
                        {{ Form::select('type', ['program' => 'Program', 'elective' => 'Elective'], old('type'), ['class' => 'form-control', 'id' => 'type', 'placeholder' => 'Select Type']) }}
                        @error('type')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                    ...
                    <div class="col-3">
                      <div class="form-group">
                        ...
                        {{ Form::select('label_id', $labels, old('label_id'), ['class' => 'form-control', 'id' => 'label_id', 'placeholder' => 'Select Label']) }}
                        @error('label_id')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        {{ Form::select('type_2', ['Inhouse' => 'Inhouse', 'Open' => 'Open'], old('type_2'), ['class' => 'form-control', 'id' => 'type_2', 'placeholder' => 'Select Option']) }}
                        @error('type_2')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <textarea name="long_description" class="form-control tiny" id="long_description" placeholder="Long Description" rows="5" >{{ old('long_description') }}</textarea>
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <textarea name="who_is_it_for" class="form-control tiny" id="who_is_it_for" placeholder="Who is it for" rows="5" >{{ old('who_is_it_for') }}</textarea>
                        @error('who_is_it_for')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <textarea name="what_you_will_gain" class="form-control tiny" id="what_you_will_gain" placeholder="What you will gain" rows="5" >{{ old('what_you_will_gain') }}</textarea>
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        {{ Form::select('faculty_ids[]', $faculties, old('faculty_ids'), ['class' => 'form-control js-multiple-select', 'id' => 'faculty_ids', 'multiple' => 'multiple']) }}
                        @error('faculty_ids')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        {{ Form::select('mentor_coach_ids[]', $mentorCoaches, old('mentor_coach_ids'), ['class' => 'form-control js-multiple-select', 'id' => 'mentor_coach_ids', 'multiple' => 'multiple']) }}
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        {{ Form::select('resource_ids[]', $resources, old('resource_ids'), ['class' => 'form-control js-multiple-select', 'id' => 'resource_ids', 'multiple' => 'multiple']) }}
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                          ...
                          <input name="mentor_coach_meetings" type="text" class="form-control" id="mentor_coach_meetings" placeholder="Mentor Coach Sessions" value="{{ old('mentor_coach_meetings') }}">
                  ...
                  <div class="row">
                    <div class="col-4">
                      <div class="form-group">
                          <label for="name">Payment Mode <span class="text-danger {{ old('type') != 'program' ? 'd-none' : '' }}" id="payment_mode_star">*</span></label>
                        {{ Form::select('payment_mode', ['offline' => 'Offline', 'online' => 'Online'], old('payment_mode'), ['class' => 'form-control', 'id' => 'payment_mode', 'placeholder' => 'Select Payment Mode']) }}
                        @error('payment_mode')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        <label for="currency_id">Currency <span class="text-danger {{ old('payment_mode') != 'online' ? 'd-none' : '' }}" id="currency_id_star">*</span></label>
                        {{ Form::select('currency_id', $currencies, old('currency_id'), ['class' => 'form-control', 'id' => 'currency_id', 'placeholder' => 'Select Currency']) }}
                        @error('currency_id')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                          <label for="amount">Amount <span class="text-danger {{ old('payment_mode') != 'online' ? 'd-none' : '' }}" id="amount_star">*</span></label>
                          <input name="amount" type="text" class="form-control" id="amount" placeholder="Amount" value="{{ old('amount') }}">
                          @error('amount')
                              <span class="text-danger">{{ $message }}</span>
                          @enderror
                      </div>
