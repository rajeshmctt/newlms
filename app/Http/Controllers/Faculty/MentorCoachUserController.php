...
class MentorCoachUserController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        ])->whereHas('batch.mentorCoaches', function($q) use($user){
        ...
        return view(config('app.f_slug').'.mentor_coach_users.index', compact('title', 'breadcrumb', 'batchUsers', 'activeBatchUsersCount', 'completedBatchUsersCount', 'search', 'status', 'prevRecords'));
    }
