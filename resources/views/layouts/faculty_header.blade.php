    ...
    <ul>
      ...
      <li class="ui dropdown">
        <a href="#" class="opts_account">
          <img src="{{ asset('storage/faculties/'.Auth::user()->photo) }}" alt="" />
        </a>
        <div class="menu dropdown_account">
          <div class="channel_my">
            <div class="profile_link">
              ...
              <div class="pd_content">
                ...
                <br>
                <span>
                  <span class="vdt15">{{ $user->activeFacultyBatchesCount() }} Faculty Batches</span><br>
                  <span class="vdt15">{{ $user->activeMentorCoachBatchesCount() }} Mentor Coach Batches</span>
                </span>
              </div>
            </div>
          ...
          <a href="{{ route(config('app.f_slug').'.account.profile') }}" class="item channel_item">Settings</a>
